...
2. **Generate a new refresh token**: `python3 get_token.py`.
3. Update `.env`.
4. Check `python3 appctl.py audit` for writes you did not make.
...
- Set the bid and budget ceilings before your first live run:
  `python3 appctl.py maxbid --set --target 0.50 --budget 20`
