...
- **[superpowers/](superpowers/)** — design documents and implementation plans for
  individual features, dated. Useful when you want to know *why* something is the way it
  is.
