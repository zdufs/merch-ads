...
- `halo [--min-spend X=1.0] [--limit N=300]` → organic-halo estimate for EVERY advertised
  ...
  **The unit is the DESIGN, not the campaign.** It was TAMAS-only, keyed on campaigns
  holding exactly one ASIN — a shape a 1000-ASIN lottery campaign cannot have. Ad facts
