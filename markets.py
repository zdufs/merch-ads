...
Each market carries:
  ...
  tamas        - whether the TAMAS method runs here (US only)
"""
...
MARKETS = {
    "US": dict(profile_env="AMZN_ADS_PROFILE_ID_US", endpoint=NA, export_mkt="us", currency="USD", plus_x=2.0, tamas=True, kind="merch", label="Merch US"),
    "UK": dict(profile_env="AMZN_ADS_PROFILE_ID_UK", endpoint=EU, export_mkt="gb", currency="GBP", plus_x=1.0, tamas=False, kind="merch", label="Merch UK"),
    "DE": dict(profile_env="AMZN_ADS_PROFILE_ID_DE", endpoint=EU, export_mkt="de", currency="EUR", plus_x=1.0, tamas=False, kind="merch", label="Merch DE"),
    "FR": dict(profile_env="AMZN_ADS_PROFILE_ID_FR", endpoint=EU, export_mkt="fr", currency="EUR", plus_x=1.0, tamas=False, kind="merch", label="Merch FR"),
    "ES": dict(profile_env="AMZN_ADS_PROFILE_ID_ES", endpoint=EU, export_mkt="es", currency="EUR", plus_x=1.0, tamas=False, kind="merch", label="Merch ES"),
    "IT": dict(profile_env="AMZN_ADS_PROFILE_ID_IT", endpoint=EU, export_mkt="it", currency="EUR", plus_x=1.0, tamas=False, kind="merch", label="Merch IT"),
    "USKDP": dict(profile_env="AMZN_ADS_PROFILE_ID_US_KDP", endpoint=NA, export_mkt="us", currency="USD", plus_x=1.0, tamas=False, kind="kdp", label="KDP US"),
}
...
TEE_PRICE = {"UK": 17.49, "DE": 18.45, "FR": 19.49, "ES": 19.49, "IT": 19.49}
