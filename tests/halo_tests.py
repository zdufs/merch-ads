...
The estimator used to be TAMAS-only, keyed on campaigns that held exactly one
ASIN. These tests pin the generalisation: the unit is the DESIGN, its ad facts
