...
extension Screen {
    ...
    var help: ScreenHelp {
        ...
        case .dashboard:
            ScreenHelp(
                ...
                steps: [
                    ...
                    "The bands under it are last month, the year so far, last year, and all time.",
        ...
        case .allMarkets:
            ScreenHelp(
                summary: """
                All six markets side by side. Use it to see where the money goes across \
                the whole account, rather than inside one market.
                """,
                source: """
                ...
                steps: [
                    ...
                    "Click a market to switch the whole app over to it.",
                ],
                notes: [
        ...
        case .health:
            ScreenHelp(
                ...
                steps: [
                    ...
                    "Check data freshness per market. Three performance tables are listed and the worst of them wins.",
        ...
        case .campaigns:
            ScreenHelp(
                ...
                steps: [
                    ...
                    "Right-click any row for its actions: pause, enable, edit budget, edit bid, pin to watchlist.",
        ...
        case .targets:
            ScreenHelp(
                ...
                """,
                source: """
                The nightly targets mirror for bids and states, and the trailing-30 \
                targeting report for performance.
                """,
                steps: [
                    "Sort by spend to put the money first.",
                    "Narrow with the campaign scope. The trend chart above follows your scope.",
                    "Right-click a row for Edit Bid, Pause, Enable, or Pin to Watchlist.",
                    "Select many rows to set a bid or pause them in one pass.",
                ],
                notes: [
                    "The bid column is the target's OWN bid. When it reads inherited, the target has no bid of its own and the ad group's default rules the auction.",
        ...
        case .liveStatus:
            ScreenHelp(
                ...
                """,
                source: "A live Amazon API request. Nothing here comes from the local database.",
                steps: [
                    "Type or paste an ASIN and press Look Up.",
                    "If the current market has nothing, it searches every market for you.",
        ...
        case .profit:
            ScreenHelp(
                summary: """
                The screen ACOS cannot give you. It counts the royalty actually earned and \
                subtracts the ad spend, per design and per product type.
                """,
                source: """
                ...
                notes: [
                    ...
                    "Spend on multi-ASIN cohorts is reported separately and never presented as profit, because it cannot be assigned to one design.",
                    "Coverage tells you what share of the spend has real royalty behind it.",
                ])
        ...
        case .accumulatedAsins:
            ScreenHelp(
                ...
                steps: [
                    ...
                    "Expand a row to see the per-campaign breakdown behind the total.",
                    "Pin anything you want to keep watching.",
                ],
                notes: [
                    ...
                    "The count at the top is the TRUE total. It can be larger than the rows currently loaded.",
                ])
        ...
        case .accumulatedKeywords:
            ScreenHelp(
                ...
                steps: [
                    ...
                    "Expand a row to see which campaigns are spending on that term.",
                    "Take the bad ones to Strategy Builder or the campaign browser to negate them.",
                ],
                notes: [
                    "Only the trailing 30 days is available here — the same cumulative window Amazon reports.",
                    "The count at the top is the true total, not just the rows on screen.",
                ])
        ...
        case .watchlist:
            ScreenHelp(
                ...
                """,
                steps: [
                    "Pin from any table: right-click a row and choose Pin to Watchlist.",
        ...
        case .strategyBuilder:
            ScreenHelp(
                ...
                notes: [
                    "Negatives are permanent. There is no undo for them in this version.",
        ...
        case .demandFeed:
            ScreenHelp(
                ...
                steps: [
                    ...
                    "Press Rebuild to regenerate it from the latest data.",
                ],
                notes: [
        ...
        case .halo:
            ScreenHelp(
                ...
                steps: [
                    ...
                    "Read the estimated halo as the lift, and net halo as that lift minus the ad spend.",
        ...
        case .actions:
            ScreenHelp(
                ...
                steps: [
                    ...
                    "The approval gate makes the nightly job COLLECT negatives and pauses instead of applying them. They then wait in the Approval Queue.",
        ...
        case .approvals:
            ScreenHelp(
                ...
                steps: [
                    ...
                    "Discard the rest so the queue does not carry stale suggestions into tomorrow.",
                ],
                notes: [
                    "Nothing in this queue has been applied yet. That is the whole point of the screen.",
                    "Negatives cannot be undone once applied.",
                ])
        ...
        case .dataImport:
            ScreenHelp(
                ...
                is offered to the right sub-tab instead.
                """,
                steps: [
                    ...
                    "Sales: drop the Merch sales report. Read the coverage section for banked days and gaps; the ledger lists every import.",
                    "Ads: drop the console monthly-history export. Read the banked summary for months covered and this market's totals.",
        ...
        case .audit:
            ScreenHelp(
                ...
                notes: [
                    ...
                    "Negatives, created keywords and archived campaigns cannot be undone. Undo is simply not offered for them, rather than failing halfway.",
                ])
        ...
        case .kdpBooks:
            ScreenHelp(
                ...
                """,
                source: """
                A local config file on this Mac (kdp_books.json). No Amazon, no market — \
                these are numbers you type in, not something the nightly job pulls.
                """,
                steps: [
        ...
        case .settings:
            ScreenHelp(
                ...
                """,
                steps: [
                    "Engine folder points at the folder holding appctl.py and the databases. The badge says whether it was found.",
                    "Leave the python path empty to use the same python the nightly job uses.",
