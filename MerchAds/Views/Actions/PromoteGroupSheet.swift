...
#Preview {
    // The search term is invented on purpose. A fixture copied from the live
    // account publishes a keyword it actually bids on, which is the most
    // commercially useful thing this repository could give away — and no other
    // check can see it, because it is two ordinary words.
    PromoteGroupSheet(
        winner: HarvestWinner(searchTerm: "wobbling teapot", sourceAdGroupId: "1", kind: "keyword",
