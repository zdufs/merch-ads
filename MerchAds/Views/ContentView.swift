...
enum Screen: String, CaseIterable, Identifiable, Hashable, Codable, Sendable {
    ...
    case campaigns, targets, liveStatus, killList, kdpBooks
    ...
    var blurb: String {
        ...
        case .allMarkets:
            "All six markets side by side — trailing 30 days and year to date, grouped by currency."
        case .health:
        ...
        case .accumulatedKeywords:
            "Every keyword/target summed across all campaigns it runs in — a term can look fine in one campaign but be a disaster across ten."
        case .watchlist:
        ...
        case .harvest:
            "Converting search terms the engine collected — promote the winners into exact-match campaigns."
        case .audit:
    ...
    /// campaigns from a catalogue export, the Merch sales report, TAMAS organic
...
struct ContentView: View {
        ...
        NavigationSplitView(columnVisibility: $columnVisibility) {
            ScrollView {
                VStack(alignment: .leading, spacing: 14) {
                    ...
                    sidebarGroup("Manage", [.campaigns, .targets, .kdpBooks, .rules,
    ...
    private var detailView: some View {
        ScreenDetail(screen: selection ?? .dashboard)
    }
}
