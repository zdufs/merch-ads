...
struct RulesApprovalQueue: View {
    ...
    var body: some View {
        ...
        .confirmationDialog("Apply \(approved.count) approved change(s) to \(appState.selectedMarket)?",
            ...
            Text("Writes to Amazon (bids/pauses/negatives). KILL freeze and the economics gate still apply, and every change is logged in the Audit Trail. Bid and pause changes can be rolled back there; added negatives are permanent.")
        }
