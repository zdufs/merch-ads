...
///
/// Scope: EVERY advertised design. It began as a TAMAS-only tool, keyed on
/// campaigns that held one ASIN — a shape that cannot describe a lottery
/// campaign holding a thousand. The unit is now the DESIGN, and its ad facts are
