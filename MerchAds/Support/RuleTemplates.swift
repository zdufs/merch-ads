...
enum RuleTemplates {
    static let all: [RuleTemplate] = [
        ...
        RuleTemplate(
            ...
            blurb: "Adds an exact negative for any search term with ≥8 clicks, 0 orders and over $2 spent. The spend gate matters: clicks alone negates cheap terms that never cost you anything. Negatives can be undone from the Audit Trail.",
            text: """
            FOR EACH searchTerm:
